...
import { Phone, ArrowRight, Clock, MapPin, Shield, Wrench, Car, AlertTriangle, Disc, Settings, Users, Award } from "lucide-react"
...
export async function generateMetadata({
  ...
  return {
    title: dict.lekkeband?.seo?.title || "Lekke Band - 24/7 Professionele Bandenservice | Mobiele Hulp",
    description: dict.lekkeband?.seo?.description || "Snelle en betrouwbare hulp bij lekke banden. 24/7 ter plaatse service, reserveband montage en bandenvervaning. Direct hulp waar u ook bent.",
    keywords: dict.lekkeband?.seo?.keywords || "lekke band, bandenservice, reserveband, band vervangen, 24/7 bandenservice, mobiele bandenservice, bandenpech",
    openGraph: {
      title: dict.lekkeband?.seo?.title || "Lekke Band - 24/7 Professionele Bandenservice",
      description: dict.lekkeband?.seo?.description || "Snelle en betrouwbare hulp bij lekke banden. 24/7 ter plaatse service, reserveband montage.",
      type: "website",
      images: [
        {
          url: "/services/5.png",
          width: 1200,
          height: 630,
          alt: dict.lekkeband?.seo?.imageAlt || "Professionele lekke band service",
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: `/${locale}/diensten/lekke-band`,
    },
  }
}

export default async function LekkeBandService({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <a
                  href={`tel:${dict.lekkeband?.hero?.phone || "0852502928"}`}
                ...
                >
                  <span className="flex items-center gap-3">
                    ...
                    {dict.lekkeband?.hero?.cta || "Bel Direct: 085-250 29 28"}
                  </span>
                </a>
                ...
                >
                  <span className="mr-3">{dict.lekkeband?.hero?.whatsapp || "WhatsApp Hulp"}</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.lekkeband?.features?.title || "Waarom Onze Lekke Band Service?"}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.lekkeband?.features?.subtitle ||
                "Met professionele bandenservice en moderne apparatuur zorgen wij ervoor dat u snel weer veilig onderweg bent. Van reserveband montage tot complete bandenwissels."}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {dict.lekkeband?.features?.items?.map((feature, index) => {
              const icons = [Clock, Disc, Shield, Users]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                {dict.lekkeband?.serviceDetails?.title || "Complete Bandenservice"}
              </h2>
              <div className="space-y-6">
                {dict.lekkeband?.serviceDetails?.items?.map((service, index) => (
            ...
            <div className="relative">
              <Image
                src="/services/5.png"
                alt={dict.lekkeband?.serviceDetails?.imageAlt || "Professionele lekke band service"}
                width={600}
                height={400}
      ...
      {/* Tire Problems We Solve */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.lekkeband?.situations?.title || "Bandenproblemen Die Wij Oplossen"}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.lekkeband?.situations?.description ||
                "Van een simpele lekke band tot complete bandenwissels - wij hebben de expertise en apparatuur voor alle bandenservice behoeften van uw voertuig."}
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {dict.lekkeband?.situations?.items?.map((situation, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="md:w-3/5 text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {dict.lekkeband?.locatiesectie?.title || "Deel Uw Locatie Voor Snelle Hulp"}
            </h2>
            <p className="text-gray-700 mb-8 text-lg leading-relaxed">
              {dict.lekkeband?.locatiesectie?.description ||
                "Heeft u een lekke band? Deel uw exacte locatie zodat onze bandenservice specialisten u zo snel mogelijk kunnen vinden en helpen met reservebanden en gereedschap."}
            </p>
            <LocationButton
              dict={dict.lekkeband?.locatiebutton || { sendLocation: "Deel Locatie", loading: "Laden..." }}
            />
          </div>
          ...
          <div className="md:w-2/5 flex justify-center">
            <Image
              src="/location.gif"
              alt={dict.lekkeband?.locatiesectie?.imageAlt || "Locatie delen voor bandenservice"}
              width={200}
              height={200}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6">
              {dict.lekkeband?.emergency?.title || "Lekke Band? Bel Direct!"}
            </h2>
            <p className="text-2xl text-black mb-12 max-w-3xl mx-auto">
              {dict.lekkeband?.emergency?.subtitle ||
                "24/7 bereikbaar voor lekke band service. Reservebanden ter plekke, snelle montage en direct weer rijden."}
            </p>
          </div>
          ...
          <div className="bg-black rounded-3xl p-12 mb-16 max-w-lg mx-auto">
            ...
            <a href={`tel:0852502928`}>
              <div className="text-5xl md:text-6xl text-white font-bold mb-4">
                {dict.lekkeband?.emergency?.phone || "085-250 29 28"}
              </div>
            </a>
            <div className="text-white text-xl">
              {dict.lekkeband?.emergency?.phoneSubtitle || "Direct verbonden met onze bandenservice specialisten"}
            </div>
          </div>

          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {dict.lekkeband?.emergency?.stats?.map((stat, index) => (
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-300 mb-6 text-lg">
              {dict.footer?.description ||
                "Uw betrouwbare partner voor lekke band service en bandenservice. 24/7 bereikbaar voor alle banden gerelateerde problemen."}
            </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {dict.lekkeband?.hero?.phone || "085-250 29 28"}
                </span>
              </a>
              <Link
                href="https://wa.me/31850609880"
              ...
              >
                <span className="mr-2">{dict.lekkeband?.hero?.whatsapp || "WhatsApp Hulp"}</span>
