          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-300 mb-6 text-lg">
              {dict.footer?.description ||
                "Uw betrouwbare partner voor autoberging en voertuig stalling. 24/7 beveiligde locaties voor veilige opslag van uw voertuig."}
            </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {dict.autoberging?.hero?.phone || "085-250 29 28"}
                </span>
              </a>
              <Link
                href="https://wa.me/31850609880"
              ...
              >
                <span className="mr-2">{dict.autoberging?.hero?.whatsapp || "WhatsApp Hulp"}</span>
