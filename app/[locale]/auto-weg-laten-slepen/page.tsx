...
export async function generateMetadata({
  ...
  return {
    title: dict.autoWegLatenSlepen?.seo?.title || "Auto Weg Laten Slepen - 24/7 Snel en Veilig | Mobiele Hulp",
    description: dict.autoWegLatenSlepen?.seo?.description || "Direct uw auto van de weg laten slepen? 24/7 bereikbaar, snelle service, professioneel en veilig vervoer.",
    keywords: dict.autoWegLatenSlepen?.seo?.keywords || "auto weg laten slepen, sleepdienst, auto afslepen, 24/7 sleepdienst, pechhulp, auto bergen",
    openGraph: {
      title: dict.autoWegLatenSlepen?.seo?.title || "Auto Weg Laten Slepen - 24/7 Snel en Veilig",
      description: dict.autoWegLatenSlepen?.seo?.description || "Direct uw auto van de weg laten slepen? 24/7 bereikbaar, snelle service, professioneel en veilig vervoer.",
      type: "website",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: dict.autoWegLatenSlepen?.seo?.imageAlt || "Auto weg laten slepen",
        },
      ],
    },
    twitter: {
      ...
      title: dict.autoWegLatenSlepen?.seo?.title || "Auto Weg Laten Slepen - 24/7 Snel en Veilig",
      description: dict.autoWegLatenSlepen?.seo?.description || "Direct uw auto van de weg laten slepen? 24/7 bereikbaar, snelle service, professioneel en veilig vervoer.",
      images: ["/services/8.jpg"],
    },
    alternates: {
      canonical: `/${locale}/auto-weg-laten-slepen`,
    },
  }
}

export default async function AutoWegLatenSlepenPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage: "url(/services/8.jpg)",
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-2 bg-[#c8eb67] text-black px-4 py-2 rounded-full text-sm font-medium">
                    ...
                    {dict.autoWegLatenSlepen?.hero?.badge || "Auto Weg Laten Slepen"}
                  </div>
                  <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight">
                    <span className="text-white">{dict.autoWegLatenSlepen?.hero?.title?.part1 || "Auto Weg Laten Slepen?"}</span>
                    <br />
                    <span className="text-[#c8eb67]">{dict.autoWegLatenSlepen?.hero?.title?.part2 || "Snel & Veilig Geregeld"}</span>
                  </h1>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                  <a
                    href={`tel:${dict.autoWegLatenSlepen?.hero?.phone || "0852502928"}`}
                  ...
                  >
                    <span className="flex items-center gap-3">
                      ...
                      {dict.autoWegLatenSlepen?.hero?.cta || "Bel Direct: 085-250 29 28"}
                    </span>
                  </a>
                  <Link
                  ...
                  >
                    <span className="mr-3">{dict.autoWegLatenSlepen?.hero?.whatsapp || "WhatsApp"}</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.autoWegLatenSlepen?.features?.title || "Waarom Uw Auto Weg Laten Slepen?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.autoWegLatenSlepen?.features?.subtitle ||
                "Onze sleepdienst is 24/7 bereikbaar en zorgt voor veilig, snel en professioneel vervoer van uw auto van de weg."}
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {dict.autoWegLatenSlepen?.features?.items?.map((feature, index) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                {dict.autoWegLatenSlepen?.serviceDetails?.title || "Complete Sleepdienst voor Auto van de Weg"}
              </h2>
              <div className="space-y-6">
                {dict.autoWegLatenSlepen?.serviceDetails?.items?.map((service, index) => (
            ...
            <div className="relative mt-10 lg:mt-0">
              <Image
                src="/services/8.jpg"
                alt={dict.autoWegLatenSlepen?.serviceDetails?.imageAlt || "Auto van de weg laten slepen"}
                width={600}
                height={400}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.autoWegLatenSlepen?.situations?.title || "Wanneer Auto Weg Laten Slepen?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.autoWegLatenSlepen?.situations?.description ||
                "Of het nu gaat om pech, een ongeval of stilstand, wij slepen uw auto veilig en snel van de weg."}
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {dict.autoWegLatenSlepen?.situations?.items?.map((situation, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="md:w-3/5 text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {dict.autoWegLatenSlepen?.locatiesectie?.title || "Deel Uw Locatie voor Sleepdienst"}
            </h2>
            <p className="text-gray-700 mb-8 text-base sm:text-lg leading-relaxed">
              {dict.autoWegLatenSlepen?.locatiesectie?.description ||
                "Geef uw locatie door zodat wij u snel kunnen helpen en uw auto veilig van de weg kunnen halen."}
            </p>
            <LocationButton
              dict={dict.autoWegLatenSlepen?.locatiebutton || { sendLocation: "Deel Locatie", loading: "Laden..." }}
            />
          </div>
          <div className="md:w-2/5 flex justify-center mb-8 md:mb-0">
            <Image
              src="/location.gif"
              alt={dict.autoWegLatenSlepen?.locatiesectie?.imageAlt || "Locatie delen voor sleepdienst"}
              width={200}
              height={200}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6">
              {dict.autoWegLatenSlepen?.emergency?.title || "Direct Auto Weg Laten Slepen? Bel Nu!"}
            </h2>
            <p className="text-lg sm:text-2xl text-black mb-12 max-w-3xl mx-auto">
              {dict.autoWegLatenSlepen?.emergency?.subtitle ||
          ...
          <div className="bg-black rounded-3xl p-8 md:p-12 mb-16 max-w-lg mx-auto">
            ...
            <a href={`tel:0852502928`}>
              <div className="text-3xl sm:text-5xl md:text-6xl text-white font-bold mb-4">
                {dict.autoWegLatenSlepen?.emergency?.phone || "085-250 29 28"}
              </div>
            </a>
            <div className="text-white text-lg sm:text-xl">
              {dict.autoWegLatenSlepen?.emergency?.phoneSubtitle || "Direct verbonden met onze sleepdienst specialisten"}
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {dict.autoWegLatenSlepen?.emergency?.stats?.map((stat, index) => (
