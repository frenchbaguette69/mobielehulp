...
export async function generateMetadata({
  ...
  return {
    title: dict.autoberging?.seo?.title || "Auto Berging - 24/7 Snel en Veilig Auto's Bergen | Mobiele Hulp",
    description: dict.autoberging?.seo?.description || "Direct auto berging nodig? 24/7 bereikbaar, snelle service, professioneel en veilig uw auto geborgen na pech of ongeval.",
    keywords: dict.autoberging?.seo?.keywords || "auto berging, auto bergen, bergingsdienst, auto ongeluk, auto afslepen, 24/7 berging, pechhulp",
    openGraph: {
      title: dict.autoberging?.seo?.title || "Auto Berging - 24/7 Snel en Veilig Auto's Bergen",
      description: dict.autoberging?.seo?.description || "Direct auto berging nodig? 24/7 bereikbaar, snelle service, professioneel en veilig uw auto geborgen na pech of ongeval.",
      type: "website",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: dict.autoberging?.seo?.imageAlt || "Professionele auto berging",
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: `/${locale}/auto-berging`,
    },
  }
}

export default async function AutoBergingPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-2 bg-[#c8eb67] text-black px-4 py-2 rounded-full text-sm font-medium">
                    ...
                    {dict.autoberging?.hero?.badge || "Auto Berging"}
                  </div>
                  <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight">
                    <span className="text-white">{dict.autoberging?.hero?.title?.part1 || "Auto Berging Nodig?"}</span>
                    <br />
                    <span className="text-[#c8eb67]">{dict.autoberging?.hero?.title?.part2 || "Snel & Veilig Geborgen"}</span>
                  </h1>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                  ...
                  >
                    <span className="mr-3">{dict.autoberging?.hero?.whatsapp || "WhatsApp"}</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.autoberging?.features?.title || "Waarom Onze Auto Berging?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.autoberging?.features?.subtitle ||
                "Onze bergingsdienst is 24/7 bereikbaar en zorgt voor veilig, snel en professioneel bergen van uw auto na pech of ongeval."}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                {dict.autoberging?.serviceDetails?.title || "Complete Auto Berging Service"}
              </h2>
              <div className="space-y-6">
            ...
            <div className="relative mt-10 lg:mt-0">
              <Image
                src="/services/6.png"
                alt={dict.autoberging?.serviceDetails?.imageAlt || "Professionele auto berging"}
                width={600}
                height={400}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.autoberging?.situations?.title || "Wanneer Auto Berging Nodig?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.autoberging?.situations?.description ||
                "Of het nu gaat om een ongeval, pech of een niet-rijdende auto, wij bergen uw voertuig snel en veilig."}
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="md:w-3/5 text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {dict.autoberging?.locatiesectie?.title || "Deel Uw Locatie voor Auto Berging"}
            </h2>
          ...
          <div className="md:w-2/5 flex justify-center mb-8 md:mb-0">
            <Image
              src="/location.gif"
              alt={dict.autoberging?.locatiesectie?.imageAlt || "Locatie delen voor auto berging"}
              width={200}
              height={200}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6">
              {dict.autoberging?.emergency?.title || "Direct Auto Berging Nodig? Bel Nu!"}
            </h2>
            <p className="text-lg sm:text-2xl text-black mb-12 max-w-3xl mx-auto">
              {dict.autoberging?.emergency?.subtitle ||
                "24/7 bereikbaar voor auto berging. Snel ter plaatse, altijd veilig bergen."}
            </p>
          </div>
          <div className="bg-black rounded-3xl p-8 md:p-12 mb-16 max-w-lg mx-auto">
            ...
            <div className="text-white text-lg sm:text-xl">
              {dict.autoberging?.emergency?.phoneSubtitle || "Direct verbonden met onze bergingsspecialisten"}
            </div>
          </div>
