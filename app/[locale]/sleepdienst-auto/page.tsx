...
export async function generateMetadata({
  ...
  return {
    title: dict.sleepdienstauto?.seo?.title || "Sleepdienst Auto - 24/7 Snel en Veilig Auto's Slepen | Mobiele Hulp",
    description: dict.sleepdienstauto?.seo?.description || "Direct een sleepdienst nodig? 24/7 bereikbaar, snelle service, professioneel en veilig uw auto laten slepen naar elke locatie.",
    keywords: dict.sleepdienstauto?.seo?.keywords || "sleepdienst, auto slepen, sleepservice, auto transport, 24/7 sleepdienst, pechhulp, auto afslepen",
    openGraph: {
      title: dict.sleepdienstauto?.seo?.title || "Sleepdienst Auto - 24/7 Snel en Veilig Auto's Slepen",
      description: dict.sleepdienstauto?.seo?.description || "Direct een sleepdienst nodig? 24/7 bereikbaar, snelle service, professioneel en veilig uw auto laten slepen naar elke locatie.",
      type: "website",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: dict.sleepdienstauto?.seo?.imageAlt || "Professionele sleepdienst auto",
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: `/${locale}/sleepdienst-auto`,
    },
  }
}

export default async function SleepdienstAutoPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-2 bg-[#c8eb67] text-black px-4 py-2 rounded-full text-sm font-medium">
                    ...
                    {dict.sleepdienstauto?.hero?.badge || "Sleepdienst Auto"}
                  </div>
                  <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight">
                    <span className="text-white">{dict.sleepdienstauto?.hero?.title?.part1 || "Sleepdienst Nodig?"}</span>
                    <br />
                    <span className="text-[#c8eb67]">{dict.sleepdienstauto?.hero?.title?.part2 || "Snel & Veilig Gesleept"}</span>
                  </h1>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                  <a
                    href={`tel:${dict.sleepdienstauto?.hero?.phone || "0852502928"}`}
                  ...
                  >
                    <span className="flex items-center gap-3">
                      ...
                      {dict.sleepdienstauto?.hero?.cta || "Bel Direct: 085-250 29 28"}
                    </span>
                  </a>
                  <Link
                  ...
                  >
                    <span className="mr-3">{dict.sleepdienstauto?.hero?.whatsapp || "WhatsApp"}</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.sleepdienstauto?.features?.title || "Waarom Onze Sleepdienst?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.sleepdienstauto?.features?.subtitle ||
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {dict.sleepdienstauto?.features?.items?.map((feature, index) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                {dict.sleepdienstauto?.serviceDetails?.title || "Complete Sleepdienst Service"}
              </h2>
              <div className="space-y-6">
                {dict.sleepdienstauto?.serviceDetails?.items?.map((service, index) => (
            ...
            <div className="relative mt-10 lg:mt-0">
              <Image
                src="/services/5.png"
                alt={dict.sleepdienstauto?.serviceDetails?.imageAlt || "Professionele sleepdienst auto"}
                width={600}
                height={400}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {dict.sleepdienstauto?.situations?.title || "Wanneer Sleepdienst Nodig?"}
            </h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
              {dict.sleepdienstauto?.situations?.description ||
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {dict.sleepdienstauto?.situations?.items?.map((situation, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="md:w-3/5 text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {dict.sleepdienstauto?.locatiesectie?.title || "Deel Uw Locatie voor Sleepdienst"}
            </h2>
            <p className="text-gray-700 mb-8 text-base sm:text-lg leading-relaxed">
              {dict.sleepdienstauto?.locatiesectie?.description ||
                "Geef uw locatie door zodat wij u snel kunnen helpen en uw auto veilig kunnen vervoeren."}
            </p>
            <LocationButton
              dict={dict.sleepdienstauto?.locatiebutton || { sendLocation: "Deel Locatie", loading: "Laden..." }}
            />
          </div>
          <div className="md:w-2/5 flex justify-center mb-8 md:mb-0">
            <Image
              src="/location.gif"
              alt={dict.sleepdienstauto?.locatiesectie?.imageAlt || "Locatie delen voor sleepdienst"}
              width={200}
              height={200}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6">
              {dict.sleepdienstauto?.emergency?.title || "Direct Sleepdienst Nodig? Bel Nu!"}
            </h2>
            <p className="text-lg sm:text-2xl text-black mb-12 max-w-3xl mx-auto">
              {dict.sleepdienstauto?.emergency?.subtitle ||
          ...
          <div className="bg-black rounded-3xl p-8 md:p-12 mb-16 max-w-lg mx-auto">
            ...
            <a href={`tel:0852502928`}>
              <div className="text-3xl sm:text-5xl md:text-6xl text-white font-bold mb-4">
                {dict.sleepdienstauto?.emergency?.phone || "085-250 29 28"}
              </div>
            </a>
            <div className="text-white text-lg sm:text-xl">
              {dict.sleepdienstauto?.emergency?.phoneSubtitle || "Direct verbonden met onze sleepdienst specialisten"}
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {dict.sleepdienstauto?.emergency?.stats?.map((stat, index) => (
